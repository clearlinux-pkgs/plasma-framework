...
Version  : 5.99.0
Release  : 58
URL      : https://download.kde.org/stable/frameworks/5.99/plasma-framework-5.99.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.99/plasma-framework-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/plasma-framework-5.99.0.tar.xz.sig
...
%prep
%setup -q -n plasma-framework-5.99.0
cd %{_builddir}/plasma-framework-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665439821
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Plasma.so.5.99.0
/usr/lib64/libKF5PlasmaQuick.so.5
/usr/lib64/libKF5PlasmaQuick.so.5.99.0
