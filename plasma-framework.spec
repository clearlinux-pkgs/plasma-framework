...
%prep
%setup -q -n plasma-framework-5.103.0
cd %{_builddir}/plasma-framework-5.103.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676323175
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Plasma.so.5.103.0
/usr/lib64/libKF5PlasmaQuick.so.5
/usr/lib64/libKF5PlasmaQuick.so.5.103.0
