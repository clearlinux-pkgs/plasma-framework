...
Version  : 5.48.0
Release  : 1
URL      : https://github.com/KDE/plasma-framework/archive/v5.48.0.tar.gz
Source0  : https://github.com/KDE/plasma-framework/archive/v5.48.0.tar.gz
...
%prep
%setup -q -n plasma-framework-5.48.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1532304920
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5Plasma.so.5.48.0
/usr/lib64/libKF5PlasmaQuick.so.5
/usr/lib64/libKF5PlasmaQuick.so.5.48.0
