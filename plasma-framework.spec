...
Version  : 5.49.0
Release  : 2
URL      : https://github.com/KDE/plasma-framework/archive/v5.49.0.tar.gz
Source0  : https://github.com/KDE/plasma-framework/archive/v5.49.0.tar.gz
...
%prep
%setup -q -n plasma-framework-5.49.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1534116212
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5Plasma.so.5.49.0
/usr/lib64/libKF5PlasmaQuick.so.5
/usr/lib64/libKF5PlasmaQuick.so.5.49.0
